...
__ALIGN_BEGIN static uint8_t HID_JOY_ReportDesc[]  __ALIGN_END =
{
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
    ...
    sizeof(HID_JOY_ReportDesc),/*wItemLength: Total length of Report descriptor*/
    0x00,
                               ...
                               uint8_t cfgidx)
{
    ...
    USBD_LL_PrepareReceive(pdev, HID_EPOUT_ADDR,
...
uint8_t USBD_HID_EP0_RxReady(USBD_HandleTypeDef *pdev)
{
    ...
    {
        if (hhid->HIDRxBuffer[0] == 2)
        {
            x_low_th  = hhid->HIDRxBuffer[3] + ((unsigned short) hhid->HIDRxBuffer[4]  << 8);
            x_high_th = hhid->HIDRxBuffer[5] + ((unsigned short) hhid->HIDRxBuffer[6]  << 8);
            y_low_th  = hhid->HIDRxBuffer[7] + ((unsigned short) hhid->HIDRxBuffer[8]  << 8);
            y_high_th = hhid->HIDRxBuffer[9] + ((unsigned short) hhid->HIDRxBuffer[10] << 8);
